// Ruta de archivo: PlataformaEncuentroNestJS/apps/api-gateway/src/app/auth/auth.controller.ts
...
export class AuthController {
  ...
  async register(@Body() body: { username: string; password: string; role: string }) {
    return await firstValueFrom(this.authClient.send('auth-create-user', body));
  }
}
